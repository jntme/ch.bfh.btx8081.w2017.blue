...
/**
 * Activities can be displayed, changed and created with this view.
 *
 * @author jntme, ziegm1
 */
public class ActivityViewImpl extends VerticalLayout implements ActivityView, View {
    ...
    /**
     * Initializes the form to edit activity data.
     */
    ...
    /**
     * Gets called to change to the real instance of the activity after it has been created.
     * It also displays a Notification.
     */
    @Override
